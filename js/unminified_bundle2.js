...
! function t(e, i, n) {
    ...
    3: [function(require, module, exports) {
        ...
        module.exports = Winwheel2, Winwheel2.prototype.updateSegmentSizes = function() {
            if (this.segments) {
                var t = 0,
                    e = 0;
        ...
        }, Winwheel2.prototype.clearCanvas = function() {
            this.ctx && this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height)
        }, Winwheel2.prototype.draw = function(t) {
        ...
        }, Winwheel2.prototype.drawPins = function() {
        ...
        }, Winwheel2.prototype.drawPointerGuide = function() {
        ...
        }, Winwheel2.prototype.drawWheelImage = function() {
        ...
        }, Winwheel2.prototype.drawSegmentImages = function() {
        ...
        }, Winwheel2.prototype.drawSegments = function() {
            if (this.ctx && this.segments)
                for (x = 1; x <= this.numSegments; x++) {
                    var t, e, i;
        ...
        }, Winwheel2.prototype.drawSegmentText = function() {
        ...
        }, Winwheel2.prototype.degToRad = function(t) {
            return .017453292519943295 * t
        }, Winwheel2.prototype.setCenter = function(t, e) {
            this.centerX = t, this.centerY = e
        }, Winwheel2.prototype.addSegment = function(t, e) {
            var i;
        ...
        }, Winwheel2.prototype.setCanvasId = function(t) {
        ...
        }, Winwheel2.prototype.deleteSegment = function(t) {
        ...
        }, Winwheel2.prototype.windowToCanvas = function(t, e) {
        ...
        }, Winwheel2.prototype.getSegmentAt = function(t, e) {
            var i = null,
                n = this.getSegmentNumberAt(t, e);
            return null !== n && (i = this.segments[n]), i
        }, Winwheel2.prototype.getSegmentNumberAt = function(t, e) {
            ...
            return g
        }, Winwheel2.prototype.getIndicatedSegment = function() {
            var t = this.getIndicatedSegmentNumber();
            return this.segments[t]
        }, Winwheel2.prototype.getIndicatedSegmentNumber = function() {
            var t = 0,
            ...
            return t
        }, Winwheel2.prototype.getRotationPosition = function() {
            ...
            return t
        }, Winwheel2.prototype.startAnimation = function() {
            if (this.animation) {
        ...
        }, Winwheel2.prototype.stopAnimation = function(t) {
    ...
    4: [function(t, e, i) {
        ...
        const g = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"],
            u = ["#773ddc", "#773ddc", "#773ddc", "#773ddc", "#773ddc", "#773ddc", "#773ddc", "#773ddc", "#773ddc", "#773ddc"];
        window.lunchWheel = {
            segments: function(t) {
        ...
        window.alertPrize = function() {
            ...
            "0" != $("#stop_angle2").val() && (r.innerHTML = `${t}`), r.classList.toggle("Show", !0), h.classList.toggle("Spinning", !1), clearTimeout(o), o = setTimeout(() => {
                x()
            }, 3e3)
        }, $("#stop_angle2").bind("change", d), $("#reset_angle").bind("change", function(t) {
